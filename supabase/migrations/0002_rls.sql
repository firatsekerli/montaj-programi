...
begin
  foreach t in array tenant_tables loop
    ...
    -- NB: RLS is ENABLED but not FORCED. Client roles (anon/authenticated) are
    -- fully restricted by the policies below; trusted server-side roles
    -- (postgres/service_role, table owners) bypass RLS for seeding/admin.
